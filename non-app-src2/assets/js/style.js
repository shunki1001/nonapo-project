...
function fakeMessage() {
  ...
  $('<div class="message loading new tr-y"><figure class="avatar"><img src="./assets/img/icon04.png" /></figure><span></span></div><div class="message loading new"><figure class="avatar"><img src="./assets/img/icon04.png" /></figure><span></span></div>').appendTo($('.mCSB_container'));
  updateScrollbar();

  setTimeout(function() {
    $('.message.loading').remove();
    $('<div class="message new"><figure class="avatar"><img src="./assets/img/icon04.png" /></figure>' + Fake[i] + '</div><div class="message new"><figure class="avatar"><img src="./assets/img/icon04.png" /></figure>' + Lake[i] + '<br><img class="mtg-bg" src="./assets/img/64.png" /><div class="mtg-btn message-submit btn-gradient-bg"><a href="#" >アポなし面談</a></div></div>').appendTo($('.mCSB_container')).addClass('new');
    setDate();
    updateScrollbar();
    i++;
  }, 1000 + (Math.random() * 20) * 100);
...
$('.message-sub').click(function() {
  ...
  $('<div class="message loading new "><figure class="avatar"><img src="./assets/img/icon04.png" /></figure><span></span></div><div class="message loading new"><figure class="avatar"><img src="./assets/img/icon04.png" /></figure><span></span></div>').appendTo($('.mCSB_container '));
  updateScrollbar();

  setTimeout(function() {
    $('.message.loading').remove();
    $('<div class="message new"><figure class="avatar"><img src="./assets/img/icon04.png" /></figure>' + Like + '</div>　<div class="message new"><figure class="avatar"><img src="./assets/img/icon04.png" /></figure>' + Liks + '<br><br><div class="row chat-btns"><div class="col-md-12"><div class="btns"><a href="#"><div class="button btn-now-bg circle message-sub">資料請求</div></a></div></div><div class="col-md-12"><div class="btns"><a href="#"><div class="button btn-now-bg circle">よくある質問</div></a></div></div><div class="col-md-12"><div class="btns"><a href="#"><div class="button btn-now-bg circle">サービス紹介動画</div></a></div></div><div class="col-md-12"><div class="btns"><a href="#"><div class="button btn-now-bg circle">デモ・体験版はこちら</div></a></div></div></div></div>').appendTo($('.mCSB_container')).addClass('new');
    setDate();
    updateScrollbar();
    i++;
  }, 1000 + (Math.random() * 20) * 100);
